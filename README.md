...
В файле index.js приводится код для парсинга сайта N+1 и создания корпуса новостей за заданный период времени.

Пример вызова (при вводе менее двух дат код может сработать некорректно):

```shell
$ nodejs index.js 2019-07-01 2019-12-31
```
